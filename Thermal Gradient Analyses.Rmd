...
```{r}
colors<-c("#ff7f00", "#e41a1c", "#a65628", "#377eb8", "#984ea3")
...
protos2<-protos%>%
  group_by(ID, meantemptrial, zone) %>%
  summarize(time=sum(time), proptime=sum(proptime))

protos3<-protos%>%
  group_by(meantemptrial, zone) %>%
  summarize(time=sum(time), proptime=sum(proptime))
...
### By individual
ggplot(protos2, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity", fill="#ff7f00") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
ggplot(protos3, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity", fill="#ff7f00") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(protos2, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity",  fill="#ff7f00") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
  xlab("Temperature (Celsius)")+  ylab("Accumulated proportional time")+ ggtitle("Protonymphs by ID")+
  facet_wrap(vars(ID))
...
### Total among all individuals
ggplot(protos3, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity", fill="#ff7f00") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(deutos2, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity",  fill="#e41a1c") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### Total among all individuals
ggplot(deutos3, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity", fill="#e41a1c") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(deutos2, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity",  fill="#e41a1c") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
  xlab("Temperature (Celsius)")+  ylab("Accumulated proportional time")+ ggtitle("Deutonymphs by ID")+
  facet_wrap(vars(ID))
...
### Total among all individuals
ggplot(deutos3, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity", fill="#e41a1c") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(tritos2, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity",  fill="#a65628") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### Total among all individuals
ggplot(tritos3, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity", fill="#a65628") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(tritos2, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity",  fill="#a65628") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
  xlab("Temperature (Celsius)")+  ylab("Accumulated proportional time")+ ggtitle("Tritonymphs by ID")+
  facet_wrap(vars(ID))
...
### Total among all individuals
ggplot(tritos3, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity", fill="#a65628") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(males2, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity",  fill="#984ea3") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### Total among all individuals
ggplot(males3, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity", fill="#984ea3") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(males2, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity",  fill="#984ea3") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
  xlab("Temperature (Celsius)")+  ylab("Accumulated proportional time")+ ggtitle("Males by ID")+
  facet_wrap(vars(ID))
...
### Total among all individuals
ggplot(males3, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity", fill="#984ea3") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(females2, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity",  fill="#377eb8") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### Total among all individuals
ggplot(females3, aes(x=meantemptrial, y=time)) +geom_bar(stat="identity", fill="#377eb8") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
### By individual
ggplot(females2, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity",  fill="#377eb8") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
  xlab("Temperature (Celsius)")+  ylab("Accumulated proportional time")+ ggtitle("Females by ID")+
  facet_wrap(vars(ID))
...
### Total among all individuals
ggplot(females3, aes(x=meantemptrial, y=proptime)) +geom_bar(stat="identity", fill="#377eb8") + 
  theme_classic()+
  theme(text = element_text(size = 15), plot.title = element_text(size = (12)), strip.text.x = element_blank(),panel.spacing = unit(7, "mm"),legend.position="none")+
...
df2<- df %>%
select(!c(Phoresy, Phoresy.checked, Thermometer.beggining, Thermometer.camera, Thermometer.end, Observations)) %>%
filter(!grepl("CPBS", Trial) ) %>%
